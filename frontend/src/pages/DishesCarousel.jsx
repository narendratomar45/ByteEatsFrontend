      ...
      <Slider {...settings}>
        {foodItems.map((item, index) => (
          <div key={index} className="px-3">
            <div className="w-44 h-44 md:w-52 md:h-52 flex flex-col justify-center items-center rounded-xl shadow-lg overflow-hidden bg-[#FFF8E9] transform transition duration-300 hover:scale-105 hover:shadow-2xl">
              <img
                src={item.image}
                alt={item.name}
